...
const Form = () => {
    ...
    return(
        <form className="w-5/6 my-20 m-auto p-20 flex items-between justify-center text-white bg-black rounded-3xl gap-10 max-xl:w-full max-xl:mx-0 max-[769px]:flex-col max-sm:p-10">
