...
const EpisodeItems = ({image, episodeNumber, title, description}: EpisodesType) => {
    return(
        <div className="max-w-350 p-8 flex bg-black rounded-3xl gap-10 max-sm:flex-col">
            <Image data-testid="target-itemImage" className="max-w-100 max-lg:w-80 max-sm:w-full" src={image} alt={title} width={1000} height={1000}/>
